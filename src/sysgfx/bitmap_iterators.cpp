...
tr::sub_bitmap::reference::reference(const std::byte* ptr, pixel_format format) noexcept
	: m_ptr{ptr}
	, m_format{format}
{
}

tr::sub_bitmap::reference::operator tr::rgba8() const noexcept
{
	return pixel_color(m_ptr, m_format);
}

tr::sub_bitmap::iterator::iterator(sub_bitmap bitmap, glm::ivec2 pos) noexcept
...
std::partial_ordering tr::sub_bitmap::iterator::operator<=>(const iterator& rhs) const noexcept
{
...
bool tr::sub_bitmap::iterator::operator==(const iterator& rhs) const noexcept
{
...
int tr::operator-(const tr::sub_bitmap::iterator& lhs, const tr::sub_bitmap::iterator& rhs) noexcept
{
...
tr::bitmap::reference::reference(std::byte* ptr, pixel_format format) noexcept
	: m_ptr{ptr}
	, m_format{format}
{
}

tr::bitmap::reference::operator tr::rgba8() const noexcept
{
	return pixel_color(m_ptr, m_format);
}

tr::bitmap::reference& tr::bitmap::reference::operator=(rgba8 color) noexcept
{
...
tr::bitmap::iterator::iterator(bitmap& bitmap, glm::ivec2 pos) noexcept
	: m_pixel{bitmap.data() + bitmap.pitch() * pos.y + pixel_bytes(bitmap.format()) * pos.x, bitmap.format()}
	, m_bitmap{bitmap}
	, m_bitmap_pos{pos}
{
...
std::partial_ordering tr::bitmap::iterator::operator<=>(const tr::bitmap::iterator& rhs) const noexcept
{
	if (m_pixel.m_ptr != nullptr && rhs.m_pixel.m_ptr != nullptr) {
		return m_pixel.m_ptr <=> rhs.m_pixel.m_ptr;
	}
...
bool tr::bitmap::iterator::operator==(const iterator& rhs) const noexcept
{
	return *this <=> rhs == std::strong_ordering::equal;
}

tr::bitmap::iterator::value_type tr::bitmap::iterator::operator*() const noexcept
{
...
tr::bitmap::iterator::pointer tr::bitmap::iterator::operator->() const noexcept
{
	return &m_pixel;
}

tr::bitmap::iterator& tr::bitmap::iterator::operator++() noexcept
{
	return *this += 1;
}

tr::bitmap::iterator& tr::bitmap::iterator::operator+=(int diff) noexcept
{
...
tr::bitmap::iterator& tr::bitmap::iterator::operator+=(glm::ivec2 diff) noexcept
{
...
int tr::operator-(const tr::bitmap::iterator& lhs, const tr::bitmap::iterator& rhs) noexcept
{
...
glm::ivec2 tr::bitmap::iterator::pos() const noexcept
{
	return m_bitmap_pos;
}