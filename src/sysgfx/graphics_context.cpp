///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
//                                                                                                                                       //
// Implements the non-templated parts of graphics_context.hpp.                                                                           //
//                                                                                                                                       //
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
void tr::gfx::set_wireframe_mode(bool arg)
{
	...
	glPolygonMode(GL_FRONT_AND_BACK, arg ? GL_LINE : GL_FILL);
}
...
void tr::gfx::set_shader_pipeline(const shader_pipeline& pipeline)
{
	...
	glBindProgramPipeline(pipeline.m_ppo.get());
}
...
void tr::gfx::set_blend_mode(const blend_mode& bm)
{
	...
	glBlendEquationSeparate(GLenum(bm.rgb_fn), GLenum(bm.alpha_fn));
	glBlendFuncSeparate(GLenum(bm.rgb_src), GLenum(bm.rgb_dst), GLenum(bm.alpha_src), GLenum(bm.alpha_dst));
}
...
void tr::gfx::set_vertex_format(const vertex_format& format)
{
	...
	glBindVertexArray(format.m_vao.get());
...
void tr::gfx::set_vertex_buffer(const basic_static_vertex_buffer& buffer, int slot, ssize offset, usize stride)
{
	...
	glBindVertexBuffer(slot, buffer.id(), offset, GLsizei(stride));
}
...
void tr::gfx::draw(primitive type, usize offset, usize vertices)
{
	...
	glDrawArrays(GLenum(type), GLint(offset), GLsizei(vertices));
}
...
void tr::gfx::draw_instances(primitive type, usize offset, usize vertices, int instances)
{
	...
	glDrawArraysInstanced(GLenum(type), GLint(offset), GLsizei(vertices), instances);
}
...
void tr::gfx::draw_indexed(primitive type, usize offset, usize indices)
{
	...
	glDrawElements(GLenum(type), GLsizei(indices), GL_UNSIGNED_SHORT, (const void*)(offset * sizeof(u16)));
}
...
void tr::gfx::draw_indexed_instances(primitive type, usize offset, usize indices, int instances)
{
	...
	glDrawElementsInstanced(GLenum(type), GLsizei(indices), GL_UNSIGNED_SHORT, (const void*)(offset * sizeof(u16)), instances);
}