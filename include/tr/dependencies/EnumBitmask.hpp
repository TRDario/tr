...
namespace EnumBitmask {
	template <class Enum> struct EnumWrapper {
		Enum e;
	...
	template <class Enum> EnumWrapper(Enum e) -> EnumWrapper<Enum>;
} // namespace EnumBitmask
...
#define DEFINE_BITMASK_OPERATORS(ENUM)                                                                                 \
	...
	{                                                                                                                  \
		...
		return EnumBitmask::EnumWrapper{ENUM(static_cast<U>(lhs) & static_cast<U>(rhs))};                              \
	}                                                                                                                  \
	[[nodiscard]]                                                                                                      \
	inline constexpr auto operator|(ENUM lhs, ENUM rhs) noexcept                                                       \
	{                                                                                                                  \
