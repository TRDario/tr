...
//     - tr::basic_static_vertex_buffer -> untyped static vertex buffer                                                                  //
//     - tr::static_vertex_buffer<Element> -> typed static vertex buffer                                                                 //
//     - tr::basic_dyn_vertex_buffer -> untyped dynamic vertex buffer                                                                    //
...
//                                                                                                                                       //
// The label of a vertex buffer can be set with .set_label() and gotten with .label():                                                   //
//     - vbuf.set_label("Example buffer"); vbuf.label() -> "Example buffer"                                                              //
//                                                                                                                                       //
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
namespace tr {
	...
	template <standard_layout Element> class static_vertex_buffer : private basic_static_vertex_buffer {
	  public:
		// Creates a static vertex buffer.
		template <typed_contiguous_const_range<Element> Range> static_vertex_buffer(graphics_context& context, Range&& range);
	...
	template <standard_layout Element> class dyn_vertex_buffer : private basic_dyn_vertex_buffer {
	  public:
		...
		void reserve(usize capacity);
		// Sets the contents of the buffer, potentially reallocating it.
		template <typed_contiguous_const_range<Element> Range> void set(Range&& data);
		// Sets a region of the buffer.
		template <typed_contiguous_const_range<Element> Range> void set_region(usize offset, Range&& data);
