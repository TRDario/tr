...
tr::gfx::dyn_atlas<Key, Extra, Hash, Pred>::dyn_atlas(glm::ivec2 size)
	: m_tex{size, tr::gfx::mipmaps::enabled}
{
}

template <typename Key, typename Extra, tr::hasher<Key> Hash, tr::equality_predicate<Key> Pred>
tr::gfx::dyn_atlas<Key, Extra, Hash, Pred>::dyn_atlas(bitmap_atlas<Key, Extra, Hash, Pred>&& source)
	: m_tex{source.bitmap, tr::gfx::mipmaps::enabled}, m_rects{std::move(source.rects)}
{
}

template <typename Key, typename Extra, tr::hasher<Key> Hash, tr::equality_predicate<Key> Pred>
tr::gfx::dyn_atlas<Key, Extra, Hash, Pred>::operator const tr::gfx::texture&() const
{
	return m_tex;
}

template <typename Key, typename Extra, tr::hasher<Key> Hash, tr::equality_predicate<Key> Pred>
tr::gfx::dyn_atlas<Key, Extra, Hash, Pred>::operator tr::gfx::texture_ref() const
{
	return m_tex;
}

template <typename Key, typename Extra, tr::hasher<Key> Hash, tr::equality_predicate<Key> Pred>
void tr::gfx::dyn_atlas<Key, Extra, Hash, Pred>::set_filtering(min_filter min_filter, mag_filter mag_filter)
{
	m_tex.set_filtering(min_filter, mag_filter);
}

template <typename Key, typename Extra, tr::hasher<Key> Hash, tr::equality_predicate<Key> Pred>
glm::ivec2 tr::gfx::dyn_atlas<Key, Extra, Hash, Pred>::size() const
{
	return m_tex.size();
}
...
bool tr::gfx::dyn_atlas<Key, Extra, Hash, Pred>::contains(Keylike&& key) const
{
	return m_rects.contains(std::forward<Keylike>(key));
}

template <typename Key, typename Extra, tr::hasher<Key> Hash, tr::equality_predicate<Key> Pred>
tr::usize tr::gfx::dyn_atlas<Key, Extra, Hash, Pred>::entries() const
{
...
template <typename Key, typename Extra, tr::hasher<Key> Hash, tr::equality_predicate<Key> Pred>
template <tr::hash_keylike<Key, Hash, Pred> Keylike>
tr::frect2 tr::gfx::dyn_atlas<Key, Extra, Hash, Pred>::operator[](Keylike&& key) const
{
...
template <typename Key, typename Extra, tr::hasher<Key> Hash, tr::equality_predicate<Key> Pred>
template <tr::hash_keylike<Key, Hash, Pred> Keylike>
tr::irect2 tr::gfx::dyn_atlas<Key, Extra, Hash, Pred>::unnormalized(Keylike&& key) const
{
...
template <typename Key, typename Extra, tr::hasher<Key> Hash, tr::equality_predicate<Key> Pred>
void tr::gfx::dyn_atlas<Key, Extra, Hash, Pred>::add(Key key, const sub_bitmap& bitmap)
	requires(std::same_as<Extra, void>)
{
...
void tr::gfx::dyn_atlas<Key, Extra, Hash, Pred>::add(Key key, const sub_bitmap& bitmap, Args&&... args)
{
	...
	if (!tl.has_value()) {
		...
		if (m_tex.size() == glm::ivec2{}) {
			const glm::uvec2 usize{bitmap.size()};
			new_size = {std::bit_ceil(usize.x + 1), std::bit_ceil(usize.y + 1)};
			tl = m_rects.try_insert(std::move(key), usize, new_size, std::forward<Args>(args)...);
		}
		else {
			new_size = size();
			do {
				new_size.y < new_size.x ? new_size.y *= 2 : new_size.x *= 2;
			} while (!(tl = m_rects.try_insert(std::move(key), bitmap.size(), new_size, std::forward<Args>(args)...)).has_value());
		}
		reserve(new_size);
	}
...
template <typename Key, typename Extra, tr::hasher<Key> Hash, tr::equality_predicate<Key> Pred>
void tr::gfx::dyn_atlas<Key, Extra, Hash, Pred>::clear()
{
	if (size() != glm::ivec2{0}) {
		m_tex.clear({});
		m_rects.clear();
...
template <typename Key, typename Extra, tr::hasher<Key> Hash, tr::equality_predicate<Key> Pred>
std::string tr::gfx::dyn_atlas<Key, Extra, Hash, Pred>::label() const
{
	return m_tex.label();
}

template <typename Key, typename Extra, tr::hasher<Key> Hash, tr::equality_predicate<Key> Pred>
void tr::gfx::dyn_atlas<Key, Extra, Hash, Pred>::set_label(std::string_view label)
{
