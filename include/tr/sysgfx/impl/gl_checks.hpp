...
template <typename FormatContext> constexpr auto TR_FMT::formatter<tr::glsl_type>::format(tr::glsl_type t, FormatContext& ctx) const
{
	const char* str;
	switch (t) {
	case tr::glsl_type::bool_:
		str = "bool";
		break;
	case tr::glsl_type::bvec2:
		str = "bvec2";
		break;
	case tr::glsl_type::bvec3:
		str = "bvec3";
		break;
	case tr::glsl_type::bvec4:
		str = "bvec4";
		break;
	case tr::glsl_type::int_:
		str = "int";
		break;
	case tr::glsl_type::ivec2:
		str = "ivec2";
		break;
	case tr::glsl_type::ivec3:
		str = "ivec3";
		break;
	case tr::glsl_type::ivec4:
		str = "ivec4";
		break;
	case tr::glsl_type::uint:
		str = "unsigned int";
		break;
	case tr::glsl_type::uvec2:
		str = "uvec2";
		break;
	case tr::glsl_type::uvec3:
		str = "uvec3";
		break;
	case tr::glsl_type::uvec4:
		str = "uvec4";
		break;
	case tr::glsl_type::float_:
		str = "float";
		break;
	case tr::glsl_type::vec2:
		str = "vec2";
		break;
	case tr::glsl_type::vec3:
		str = "vec3";
		break;
	case tr::glsl_type::vec4:
		str = "vec4";
		break;
	case tr::glsl_type::mat2:
		str = "mat2";
		break;
	case tr::glsl_type::mat3:
		str = "mat3";
		break;
	case tr::glsl_type::mat4:
		str = "mat4";
		break;
	case tr::glsl_type::mat2x3:
		str = "mat2x3";
		break;
	case tr::glsl_type::mat2x4:
		str = "mat2x4";
		break;
	case tr::glsl_type::mat3x2:
		str = "mat3x2";
		break;
	case tr::glsl_type::mat3x4:
		str = "mat3x4";
		break;
	case tr::glsl_type::mat4x2:
		str = "mat4x2";
		break;
	case tr::glsl_type::mat4x3:
		str = "mat4x3";
		break;
	case tr::glsl_type::sampler2D:
		str = "sampler2D";
		break;
	default:
		str = "<unknown>";
